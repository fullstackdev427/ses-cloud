...
"enum_engineers": """SELECT
  ...
  LEFT JOIN `ft_engineer_internal_notes` AS `INTERNAL_NOTES`
    ON `MT`.`id` = `INTERNAL_NOTES`.`engineer_id`
...
"create_engineer": """INSERT INTO `mt_engineers` (
  ...
  `station_cd`,`station_pref_cd`,`station_line_cd`,`station_lon`,`station_lat`,`flg_public`,`web_public`,`client_id`, `client_name`, `addr_vip`,`addr1`, `addr2`,
  `flg_careful`
  )
  VALUES (
    %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
    %s, %s, %s, %s, valid_user_id_full(%s, %s, %s), %s, %s, %s, %s, %s, valid_user_company(%s, %s, %s), %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);""",\
"create_engineer_note": """INSERT INTO `ft_engineer_notes` VALUES (%s, %s);""",\
"create_engineer_internal_note": """INSERT INTO `ft_engineer_internal_notes` VALUES (%s, %s);""",\
...
"update_internal_note": """INSERT INTO `ft_engineer_internal_notes` (`engineer_id`, `internal_note`) VALUES (%s, %s) ON DUPLICATE KEY UPDATE `internal_note`=%s;""",\
...
"update_matching_engineer": """UPDATE `mt_engineers` SET `flg_public` = 0, `is_show_matching` = 0 WHERE `id` = %s;"""\
	...
	def __cvt_enum_engineers(cls, cur):
		...
		for res in cur:
			...
			tmp_obj['web_public'] = bool(res[37])
			tmp_obj['client_id'] = res[38]
			tmp_obj['client_name'] = res[39]
			tmp_obj['owner_company_id'] = res[40]
			tmp_obj['addr_vip'] = res[41]
			tmp_obj['addr1'] = res[42]
			tmp_obj['addr2'] = res[43]
			tmp_obj['flg_careful'] = bool(res[44])
			tmp_obj['internal_note'] = res[45]
	...
	def __cvt_enum_bp_engineers(cls, cur):
		...
		for res in cur:
			...
			tmp_obj['flg_public'] = bool(res[36])
			tmp_obj['web_public'] = bool(res[37])
			tmp_obj['owner_company_id'] = res[38]
			tmp_obj['internal_note'] = res[39]
			tmp_obj['preparations'] = []
			result.append(tmp_obj)
		return result
	...
	def __cvt_search_engineers(cls, cur):
		...
		for res in cur:
			...
			tmp_obj['web_public'] = bool(res[41])
			tmp_obj['create_from_promo'] = res[42]
			tmp_obj['company_tel'] = res[43]
			tmp_obj['internal_note'] = res[44]
			tmp_obj['preparations'] = []
			tmp_obj['skill_level_list'] = []
			result.append(tmp_obj)
		return result
