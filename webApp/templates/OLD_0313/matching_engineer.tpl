...
{#                                {% endif %}#}
                        ...
                        <table class="view_table table-bordered table-hover">
                            ...
                            {% if data['engineer.enumEngineers'] %}
					            ...
					            {% for item in items %}
                                <tr {% if item.owner_company_id != data["auth.userProfile"].company.id %}style="background-color:rgba(3, 169, 244, 0.15)" {% elif item.create_from_promo == 0 %} style="background-color:rgba(3, 169, 0, 0.2)" {% endif %}>
                                    <td class="center">
