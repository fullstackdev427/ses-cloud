...
<div class="row">
    <div class="container" style="margin-bottom:100px;margin-top:30px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-2">
                        ...
                        <span id="quotation_header_label">請求先注文書</span>
                    </div>
                    <div class="col-xs-7">
        ...
        <input type="hidden" id="client_worker_ids" value="{% if data['operation.enumOperations'] %}{{ data['operation.enumOperations'][0].worker_id_list|e }}{% endif %}"/>
        ...
        <div class="row" style="border: solid #999999;border-width: thin;">
            <div class="col-xs-12" style="margin-left:40px;margin-right:30px;margin-top:30px;">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <table class="">
                            ...
                            <tr>
                                <td style="background-color: #eaeaea; width: 70pt; padding-left: 10pt;"><span id="quotation_date_label">注文日</span></td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <h3><span id="client_name">
                            {{ data['manage.readUserProfile'].company.name|e }}
                        </span>　</h3>
                        <p>担当：
                        {% if data['manage.readUserProfile'].company.order_charging_user_id %}
                            {% for item in data['manage.enumAccounts'] %}
                                {% if item.is_enabled == True %}
                                    {% if item.id == data['manage.readUserProfile'].company.order_charging_user_id %}{{ item.name|e }}{% endif %}
                                {% endif %}
                            {% endfor %}
                        {% endif %}
                        </p>
                    ...
                    <div class="col-xs-4">
                        ...
                        <p style="position: absolute; z-index: 2;">
                            〒<span id="order_client_addr_vip"></span>&nbsp;<br/>
											<span id="order_client_addr1"></span><br/>
											<span id="order_client_addr2"></span><br/>
                            TEL：<span id="order_client_tel"></span><br/>
                            FAX：<span id="order_client_fax"></span><br/>

                        </p>
{#                        <img border="0" style="position: absolute; z-index: 1; left: 150px;top: 100px;" src="{{ data['manage.readUserProfile'].company.company_seal|e }}" width="100" height="100" alt="社印">#}
                    </div>
                </div>
            </div>
